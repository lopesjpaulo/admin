...
class ModuleController extends Controller
{
    ...
    public function store(ModuleFormRequest $request)
    {
        ...
        if (isset($module) && !is_null($module)) {
        	// CRUD permissions
        	Permission::create(array('title' => ('create_'.$module->title), 'module_id' => $module->id));
	        Permission::create(array('title' => ('read_'.$module->title), 'module_id' => $module->id));
	        Permission::create(array('title' => ('update_'.$module->title), 'module_id' => $module->id));
	        Permission::create(array('title' => ('delete_'.$module->title), 'module_id' => $module->id));
        }
